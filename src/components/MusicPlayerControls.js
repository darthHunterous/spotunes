  ...
  return (
    <>
      <div className="d-flex align-items-center player">
        ...
        {/* <PlayerIcon.Stop width={32} height={32} style={{ marginRight: 32 }} /> */}
        {/* <svg xmlns="http://www.w3.org/2000/svg" style={{ marginRight: 32 }} width="32" height="32" fill="currentColor" class="bi bi-stop-circle" viewBox="0 0 16 16">
